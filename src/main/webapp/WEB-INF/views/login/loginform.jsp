            ...
            <form action="/login" method="post" onsubmit="return loginSubmit()">
              ...
              <div class="social-login">
                ...
                <a href="http://localhost:8080/oauth2/authorization/kakao">
					<img src="/login/images/kakaotalk.png" width="200" height="auto" alt="" />
                </a>
                <a href="http://localhost:8080/oauth2/authorization/naver">
					<img src="/login/images/naver.png" width="200" height="auto" alt="" />
                </a>
                </div>
              </div> 
            </form>
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
              <h5 class="modal-title" id="myModalLabel"><strong>GoobJob 회원가입</strong></h5>
		      ...
		      <div class="col-sm-9">
		        <div class="row">
		          <div class="col-8 col-sm-6">
		            <a href="registerformMember"><button type="button" class="btn btn-outline-primary" style="width: 140px; ">개인 회원</button></a>
		          </div>
		          <div class="col-4 col-sm-6">
		            <a href="registerformCompany"><button type="button" class="btn btn-outline-primary" style="width: 140px; ">기업 회원</button></a>
		          </div>
		        </div>
		      </div>
		    </div>
		  ...
		  <div class="container-fluid">
		    <div class="row">
		      <div class="col-sm-9">
		        <div class="row">
		          <div class="col-8 col-sm-6 ">
		            <a href="findAcntMember"><button type="button" class="btn btn-outline-primary" style="width: 130px; height: 50px;">개인 회원</button></a>
		          </div>
		          <div class="col-4 col-sm-6">
		            <a href="findAcntCompany"><button type="button" class="btn btn-outline-primary" style="width: 130px; height: 50px;">기업 회원</button></a>
		          </div>
		        </div>
		      </div>
		    </div>
