...
<head>
<meta charset="UTF-8">
<title>hireWriter.jsp 채용공고페이지</title>
			...
			<div class="smallContainer">	
				...
				<div class="box1"><!-- 첫번째 영역 -->						
					<div class="mb-3 row"><!-- 기업명선택 -->
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" value="${cname.cname}"  disabled readonly> 
							<input type="hidden" class="form-control" id="cno" name="cno" value="${cname.cno }" />
						</div>
					</div>
				...
				<div class="mb-3 row"> <!-- 모집분야명 -->		
					...
					<div class="mb-3 row"> <!-- 필수/우대조건 -->
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="hreq" name="hreq"
				...
				<div><!-- 네번째영역 -->
					<div class="mb-3 row">
						<div class="col-sm-12">
							<input style="margin-bottom:30px; margin-top:10px" type="text" class="form-control" id="htitle" name="htitle" placeholder="채용제목을 입력해주세요">
						</div>
					</div>
				</div>
				...
				<div><!-- 다섯번째영역 -->
					...
					<input type="submit" id="submit" value="공고등록" class="btn btn-primary" style= "height:50px; width:500px;"  />
					</div>
